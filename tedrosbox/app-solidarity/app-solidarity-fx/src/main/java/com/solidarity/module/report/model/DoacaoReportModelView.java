...
import com.solidarity.module.report.process.DoacaoReportProcess;
...
@TSecurity(	id="SOLIDARITY_DOACAOREP_FORM", 
			appName = "#{app.name}", moduleName = "#{module.administrativo}", viewName = "Relatório de Doações",
