...
public class SaidaReportProcess extends TReportProcess<EstocavelReportModel> {


	public SaidaReportProcess() throws TProcessException {
		super("IEstocavelReportControllerRemote", "CSFSaida");
	}
	...
	protected InputStream getJasperInputStream() {
		InputStream inputStream = getClass().getResourceAsStream("/saida.jasper");
		return inputStream;
	}
