...
public class EntradaReportProcess extends TReportProcess<EstocavelReportModel> {


	public EntradaReportProcess() throws TProcessException {
		super("IEstocavelReportControllerRemote", "CSFEntrada");
	}
	...
	protected InputStream getJasperInputStream() {
		InputStream inputStream = getClass().getResourceAsStream("/entrada.jasper");
		return inputStream;
	}
