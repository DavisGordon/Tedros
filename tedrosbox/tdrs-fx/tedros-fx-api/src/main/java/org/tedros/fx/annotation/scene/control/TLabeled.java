...
import org.tedros.fx.annotation.parser.TLabeledParser;
...
/**
 * <pre>
 * Config a {@link org.tedros.fx.control.TLabel} component.
 * 
...
public @interface TLabeled {
	 ...
	 * </pre>
	 * */
	public Class<? extends TAnnotationParser<TLabeled, Labeled>>[] parser() default {TLabeledParser.class};
