...
public @interface TValidator  {
	...
	/**
	 * The validator class of type {@link org.tedros.fx.control.validator.TValidator}
	 * */
	public Class<? extends org.tedros.fx.control.validator.TValidator> validatorClass();
