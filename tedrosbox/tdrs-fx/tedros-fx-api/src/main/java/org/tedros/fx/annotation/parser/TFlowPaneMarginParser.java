...
import org.tedros.fx.annotation.layout.TFlowPane.TMargin;

import javafx.geometry.Insets;
import javafx.scene.Node;
import javafx.scene.layout.FlowPane;

public class TFlowPaneMarginParser extends TAnnotationParser<TMargin, FlowPane> {


	@Override
	public void parse(TMargin annotation, FlowPane object, String... byPass) throws Exception {
			...
			for (TFieldInset tFieldInset : arr) {
				...
				if(fd==null)
					throw new RuntimeException("[WARNING]" + getClass().getSimpleName()+
							...
							+ getComponentDescriptor().getModelView()
							.getClass().getSimpleName()+", maybe they didnt loaded yet.");
				...
				FlowPane.setMargin(node, (Insets) TTypeAnalyserParserDelegate
						.parse(tFieldInset.insets(), getComponentDescriptor()));		
			}
