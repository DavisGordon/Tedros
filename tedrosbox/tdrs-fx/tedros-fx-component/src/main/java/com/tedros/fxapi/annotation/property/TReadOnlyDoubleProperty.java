...
import com.tedros.fxapi.annotation.parser.TReadOnlyDoublePropertyParser;
...
public @interface TReadOnlyDoubleProperty {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TReadOnlyDoublePropertyParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends TAnnotationParser>[] parser() default {TReadOnlyDoublePropertyParser.class};
