...
import com.tedros.fxapi.annotation.parser.TReadOnlyIntegerPropertyParser;

/**
 * <pre>
 * Specifies listeners to the {@link ReadOnlyIntegerProperty}
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TReadOnlyIntegerProperty {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TReadOnlyStringPropertyParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends TAnnotationParser>[] parser() default {TReadOnlyIntegerPropertyParser.class};
