...
import com.tedros.fxapi.builder.TDoubleFieldBuilder;
...
/**
 * <pre>
 * Build a {@link com.tedros.fxapi.control.TDoubleField} component.
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TDoubleField  {
	
	/**
	 *<pre>
	 * The builder of type {@link ITFieldBuilder} for this component.
	 * 
	 *  Default value: {@link TDoubleFieldBuilder}
	 *</pre> 
	 * */
	public Class<? extends ITFieldBuilder> builder() default TDoubleFieldBuilder.class;
	...
	**/
	 ...
	 * Property description:
	 * 
	 * The precision for this input control.
	 * </pre>
	 * */
	public int precision() default TAnnotationDefaultValue.DEFAULT_INT_VALUE_IDENTIFICATION;
}
