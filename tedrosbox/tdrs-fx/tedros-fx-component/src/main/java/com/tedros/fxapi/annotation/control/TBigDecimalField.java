...
import com.tedros.fxapi.builder.TBigDecimalFieldBuilder;
...
/**
 * <pre>
 * Build a {@link com.tedros.fxapi.control.TBigDecimalField} component.
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TBigDecimalField  {
	
	/**
	 *<pre>
	 * The builder of type {@link ITFieldBuilder} for this component.
	 * 
	 *  Default value: {@link TBigDecimalFieldBuilder}
	 *</pre> 
	 * */
	public Class<? extends ITFieldBuilder> builder() default TBigDecimalFieldBuilder.class;
