...
import com.tedros.fxapi.builder.TFindFieldBuilder;
...
/**
 * <pre>
 * Build a {@link com.tedros.fxapi.control.TFindItem} component.
 * 
 * The find item component opens a modal that allows a user to search and select items. 
 * 
 *  Two property type can be used with this component:
 *  - SimpleObjectProperty allows the component to select just one item.
 *  - ITObservableList allows the component to select more than one item.
 *  
 * </pre>
 * @author Davis Gordon
 *
...
public @interface TFindItemField  {
	 ...
	 *</pre> 
	 * */
	public Class<? extends ITFieldBuilder> builder() default TFindFieldBuilder.class;
