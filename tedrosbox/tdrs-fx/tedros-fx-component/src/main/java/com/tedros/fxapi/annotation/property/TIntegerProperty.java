...
import com.tedros.fxapi.annotation.parser.TIntegerPropertyParser;
...
public @interface TIntegerProperty {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TIntegerPropertyParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends TAnnotationParser>[] parser() default {TIntegerPropertyParser.class};
