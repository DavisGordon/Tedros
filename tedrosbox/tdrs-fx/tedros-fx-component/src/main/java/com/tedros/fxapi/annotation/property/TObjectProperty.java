...
import com.tedros.fxapi.annotation.parser.TObjectPropertyParser;
...
public @interface TObjectProperty {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TObjectPropertyParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends TAnnotationParser>[] parser() default {TObjectPropertyParser.class};
