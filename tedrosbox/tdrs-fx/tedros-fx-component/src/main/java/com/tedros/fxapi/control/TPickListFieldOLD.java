...
public class TPickListFieldOLD<E extends ITModelView<?>> extends BorderPane {
		...
		public TPickListFieldOLD(String sourceLabel, String selectedLabel, ObservableList<E> sourceObservableList, ObservableList<E> selectedObservableList, boolean required) {
	    	try{
		    	loadFXML();     
		...
		private void loadFXML() throws IOException {
			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource( "multi_select_list_view.fxml"));
		...
		public void setSourceList(ObservableList<E> sourceList) {
			...
			if(sourceList==null)
				throw new IllegalArgumentException("sourceList n�o pode ser nulo");
			
			final ObservableList<E> sourceListTmp = FXCollections.observableArrayList();
			sourceListTmp.addAll(CollectionUtils.subtract(sourceList, this.selectedList));
