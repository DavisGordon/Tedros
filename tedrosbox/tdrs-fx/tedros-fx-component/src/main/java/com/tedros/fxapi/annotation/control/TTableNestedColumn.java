...
import com.tedros.fxapi.annotation.parser.TTableNestedColumnParser;
...
public @interface TTableNestedColumn {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TTableNestedColumnParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends ITAnnotationParser>[] parser() default {TTableNestedColumnParser.class};
