...
import com.tedros.fxapi.annotation.parser.TRequiredPasswordFieldParser;
...
import com.tedros.fxapi.builder.TPasswordFieldBuilder;
...
/**
 * <pre>
 * Build a {@link com.tedros.fxapi.control.TPasswordField} component.
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TPasswordField  {
	
	/**
	 *<pre>
	 * The builder of type {@link ITFieldBuilder} for this component.
	 * 
	 *  Default value: {@link TPasswordFieldBuilder}
	 *</pre> 
	 * */
	public Class<? extends ITFieldBuilder> builder() default TPasswordFieldBuilder.class;
