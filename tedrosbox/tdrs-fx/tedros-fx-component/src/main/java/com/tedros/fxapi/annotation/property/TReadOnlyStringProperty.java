...
import com.tedros.fxapi.annotation.parser.TReadOnlyStringPropertyParser;

/**
 * <pre>
 * Specifies listeners to the {@link ReadOnlyStringProperty}
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TReadOnlyStringProperty {
	...
	public Class<? extends TAnnotationParser>[] parser() default {TReadOnlyStringPropertyParser.class};
