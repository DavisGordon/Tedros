 ...
 *
 */
public abstract class TRequiredSelectImage extends StackPane implements ITRequirable, ITComponent{
	...
	public abstract ObservableList<ITFileBaseModel> gettSelectedFileList();
