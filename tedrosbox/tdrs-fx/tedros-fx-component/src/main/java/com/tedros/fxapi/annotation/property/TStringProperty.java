...
import com.tedros.fxapi.annotation.parser.TStringPropertyParser;

/**
 * <pre>
 * Specifies listeners to the {@link StringProperty}
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TStringProperty {
	
	/**
	 * <pre>
	 * The parser class for this annotation
	 * 
	 * Default value: {TStringPropertyParser.class}
	 * </pre>
	 * */
	@SuppressWarnings("rawtypes")
	public Class<? extends TAnnotationParser>[] parser() default {TStringPropertyParser.class};
