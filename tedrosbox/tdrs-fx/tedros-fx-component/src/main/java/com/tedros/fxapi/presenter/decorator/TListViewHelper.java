...
public class TListViewHelper<M extends TEntityModelView<? extends ITEntity>>{
	...
	public TListViewHelper(String title, double maxWidth, double minWidth, com.tedros.fxapi.annotation.view.TPaginator paginator ) {
		...
		if(paginator!=null){
			if(paginator.show()) {
				...
				if(paginator.showOrderBy())
					for(com.tedros.fxapi.annotation.view.TOption o : paginator.orderBy())
