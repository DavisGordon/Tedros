...
import com.tedros.fxapi.builder.TBigIntegerFieldBuilder;
...
/**
 * <pre>
 * Build a {@link com.tedros.fxapi.control.TBigIntegerField} component.
 * </pre>
 *
 * @author Davis Gordon
 *
...
public @interface TBigIntegerField  {
	
	/**
	 *<pre>
	 * The builder of type {@link ITFieldBuilder} for this component.
	 * 
	 *  Default value: {@link TBigIntegerFielBuilder}
	 *</pre> 
	 * */
	public Class<? extends ITFieldBuilder> builder() default TBigIntegerFieldBuilder.class;
