...
import com.tedros.fxapi.animation.BackInterpolator;
...
public final class DatePickerSkin extends HBox implements Skin<DatePicker> {
    ...
    public DatePickerSkin(final DatePicker datePicker) {
        ...
        URL url = getClass().getResource("cal.png");
        ImageView imageView = null;
		try {
			
			imageView = new ImageView(new Image(url.openStream()));
    ...
    private class AnimatedPopup extends Popup {
        ...
        @Override
        public void hide() {
            if (getOwnerWindow()!=null && !getOwnerWindow().isShowing()) {
