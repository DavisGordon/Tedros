 ...
 * 
 */
package org.somos.module.web.model;
 ...
 *
 */
@TEjbService(serviceName = "ICssClassImportControllerRemote", model=CssClassImport.class)
@TPresenter(decorator = @TDecorator(type=TImportFileModalDecorator.class, viewTitle="Importar CssClasss"),
			behavior = @TBehavior(type=TImportFileModalBehavior.class, 
			importedEntityClass=CssClass.class, importedModelViewClass=CssClassMV.class))
public class CssClassImportModelView extends TImportModelView<CssClassImport> {
	...
	@TText(text="Importar arquivo para cadastro de CssClasss", textAlignment=TextAlignment.LEFT, 
	...
	public CssClassImportModelView(CssClassImport model) {
		super(model);
