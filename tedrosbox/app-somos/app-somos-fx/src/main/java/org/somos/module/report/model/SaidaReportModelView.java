...
import org.somos.module.report.process.SaidaReportProcess;
...
@TSecurity(	id="SOMOS_SAIDAREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Saída de produtos do estoque",
