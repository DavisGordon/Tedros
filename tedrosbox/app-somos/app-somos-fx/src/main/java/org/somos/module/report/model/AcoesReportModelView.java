...
import org.somos.module.report.process.AcaoReportProcess;
...
@TSecurity(	id="SOMOS_ACAOREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Ações",
