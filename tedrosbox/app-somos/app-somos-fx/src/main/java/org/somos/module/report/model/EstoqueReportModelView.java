...
import org.somos.module.report.process.EstoqueReportProcess;
import org.somos.report.model.EstoqueModel;
...
@TSecurity(	id="SOMOS_ESTOQREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Estoque",
...
public class EstoqueReportModelView extends TModelView<EstoqueReportModel>{
	...
	@TVBox(	pane=@TPane(children={"ids", "cozinha", "origem", "texto2"}), spacing=10, fillWidth=true)
