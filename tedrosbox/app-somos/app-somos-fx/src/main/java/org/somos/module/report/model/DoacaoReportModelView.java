...
import org.somos.module.report.process.DoacaoReportProcess;
...
@TSecurity(	id="SOMOS_DOACAOREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Doações",
