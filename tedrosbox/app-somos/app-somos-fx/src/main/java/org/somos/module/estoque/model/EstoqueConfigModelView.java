...
import org.somos.module.produto.model.CarregarProdutoListener;
import org.somos.module.produto.model.ProdutoFindModelView;
...
@TSecurity(	id="SOMOS_ESTOQUECONF_FORM", 
	appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Administrar/Editar estoque",
