...
import org.somos.module.acao.behavior.MailingBehavior;
import org.somos.module.acao.behavior.MailingSaveAction;
import org.somos.module.acao.decorator.MailingDecorator;
import org.somos.module.acao.form.EmailTemplateForm;
...
@TSecurity(	id="SOMOS_MAIL_FORM", 
	appName = "#{somos.name}", moduleName = "Gerenciar Campanha", viewName = "Mailing",
