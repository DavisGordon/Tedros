...
import org.somos.module.report.process.EntradaReportProcess;
...
@TSecurity(	id="SOMOS_ENTRADAREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Entrada de produtos no estoque",
