...
import org.somos.module.acao.model.AcaoFindModelView;
...
@TSecurity(	id="SOMOS_SAIDAPROD_FORM", 
	appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Saida de Produtos",
