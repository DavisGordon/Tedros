...
import org.somos.module.report.process.VoluntarioReportProcess;
...
@TSecurity(	id="SOMOS_VOLUNREP_FORM", 
			appName = "#{somos.name}", moduleName = "Administrativo", viewName = "Relatório de Voluntários inscritos",
