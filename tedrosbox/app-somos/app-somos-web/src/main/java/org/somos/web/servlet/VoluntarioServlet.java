			...
			if(!TValidatorUtil.isEmailAddress(email)) {
				...
				try {
					...
					if(res.getResult().equals(EnumResult.SUCESS)){
						...
						out.println("Obrigado por se cadastrar agora você iniciar sua sessão pelo menu Meu Painel.");
					}else if(res.getResult().equals(EnumResult.WARNING)){
						//System.out.println(res.getErrorMessage());
						resp.setStatus(SC_ACCEPTED);	
						out.println("Faça o login pelo menu Meu Painel.");
