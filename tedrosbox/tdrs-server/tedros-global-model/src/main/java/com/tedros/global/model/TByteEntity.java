package com.tedros.global.model;
...
import com.tedros.global.domain.DomainSchema;
import com.tedros.global.domain.DomainTables;

@Entity
@Table(name = DomainTables.binary, schema = DomainSchema.tedros_global)
