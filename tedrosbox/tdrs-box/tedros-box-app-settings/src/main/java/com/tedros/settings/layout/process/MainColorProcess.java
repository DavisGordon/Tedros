 ...
 * @author Davis Gordon
 * */
public class MainColorProcess extends TModelProcess<MainColor>{
	
	private NumberFormat numberFormat;
	
	public MainColorProcess() {
	...
	@Override
	public List<TResult<MainColor>> process(MainColor obj) {
		TResult<MainColor> result = new TResult<>();
		result.setValue(obj);
		try{
			saveValues(obj);
	...
	private void saveValues(MainColor model) throws Exception{
