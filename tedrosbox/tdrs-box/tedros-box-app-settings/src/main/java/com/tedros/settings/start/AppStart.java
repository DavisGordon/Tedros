...
import com.tedros.settings.security.TSettingsModule;
...
module = {@TModule(type=LayoutModule.class, name="#{settings.module.name}", menu = "#{settings.menu.title}", 
					icon=LayoutIconImageView.class, menuIcon=LayoutMenuIconImageView.class),
		@TModule(type=TSettingsModule.class, name="Security", menu = "#{settings.menu.title}", 
